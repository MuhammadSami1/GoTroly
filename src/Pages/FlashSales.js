...
const FlashSales = () => {
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center bg-yellow-400 gap-7 py-6 px-6">
        <FlashSalesCard />
        <FlashSalesCard />
        <FlashSalesCard />
        <FlashSalesCard />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-6">
        <div>
          <img src={Slide2} alt="slide" style={{ height: "500px" }} />
        </div>
        <div className="bg-black text-yellow-400">
          ...
          <p className="uppercase text-2xl sm:text-4xl md:text-3xl lg:text-5xl tracking-tighter font-bold">
            Camera lens now 10% off on
          </p>
          <p className="uppercase text-2xl sm:text-4xl md:text-3xl  lg:text-5xl tracking-tighter sm:pt-1 pt-3 font-bold">
            entire stock !!!
          </p>
        </div>
      </div>
