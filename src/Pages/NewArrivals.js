...
const NewArrivals = () => {
  return (
    <>
      {/* New Arrivals Card */}
      <div className="flex flex-wrap justify-center bg-yellow-400 gap-10 py-10 px-10">
        <NewArrivalsCard />
        <NewArrivalsCard />
        <NewArrivalsCard />
        <NewArrivalsCard />
      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
          <h3 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold tracking-tighter pb-4 text-yellow-400">
            Phone Cases
          </h3>
          <p className="text-sm sm:text-lg md:text-3xl lg:text-5xl font-bold tracking-tighter text-yellow-400">
            OWNED BY150K PEOPLE NOW!
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-evenly mb-16 gap-7 px-12">
